...
return (this._binds[0].getValue());
		...
		sugar: {
			tag_name: "text_input",
			root_resource_name: "MAIN_ELEMENT",
			attribute_mappings: {
				value: {
					type: "property",
					type_name: "String"
...
return (this._binds[0].getValue());
	...
	CollapsiblePanel: {
		...
		extender_type: "Standard",
		template: ["\r\n\t\t\t{include> $collapsible_panel.header_wrapper}\r\n\t\t\t{include> $collapsible_panel.content_wrapper}\r\n\t\t"],
		container: {
			type: "Element",
			tag_name: "div",
			resource_id: {
		...
		includes: {
			header_wrapper: [
				"\r\n\t\t",
				{
					...
					template: ["\r\n\t\t\t{include> $collapsible_panel.header}\r\n\t\t"]
				},
				"\r\n\t"
			],
			content_wrapper: [
				"\r\n\t\t",
				{
					...
					template: [
						"\r\n\t\t\t",
						{
							...
							name: "div",
							template: ["\r\n\t\t\t\t{include> $collapsible_panel.content}\r\n\t\t\t"]
						},
						"\r\n\t\t"
					]
				},
			...
			header: ["\r\n\t\t<h3 class=\"panel-title\">{include> $collapsible_panel.title}</h3>\r\n\t"],
			title: [
				"\r\n\t\t",
				{
					type: "view",
...
return (0);
		...
		includes: {
			node: ["\r\n\t\t{include> $tree.node_body}\r\n\t\t{include> $tree.node_children}\r\n\t"],
			node_body: [
				"\r\n\t\t",
				{
					type: "view",
...
return ('level-' + this._binds[0].getValue());
					...
					template: ["\r\n\t\t\t{include> $tree.node_body_content}\r\n\t\t"]
				},
				"\r\n\t"
			],
			node_body_content: [
...
return (this._callModifier("0", [!! this._binds[0].getValue()]));
							...
							modifiers: [{
								locator_type: "Name",
								locator: "table",
								callback_name: "translateBoolean"
							}]
						}
					},
					"\r\n\t\t\t"
...
return (this._binds[0].getValue() == 'days');
				...
				template: ["\r\n\t\t\t\t{include> $calendar.days_view}\r\n\t\t\t"],
				else_template: ["\r\n\t\t\t\t{include> $calendar.months_view}\r\n\t\t\t"]
			},
			"\r\n\t\t"
		],
		container: {
