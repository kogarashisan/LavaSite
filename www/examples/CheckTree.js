...
return (this._binds[0].getValue());
							...
							"\r\n\t\t\t\t\t",
							{
								locator_type: "Name",
								locator: "tree",
								name: "FolderTree$node_body_content",
								type: "include"
							},
							"\r\n\t\t\t\t"
						]
